...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'joins_backtest', (
            ...
            ('backtest_id', self.gf('django.db.models.fields.CharField')(default='ABC', unique=True, max_length=120)),
            ('ref_id', self.gf('django.db.models.fields.CharField')(default='ABC', unique=True, max_length=120)),
            ('backtest_startrange', self.gf('django.db.models.fields.CharField')(default='ABC', unique=True, max_length=120)),
            ('backtest_endrange', self.gf('django.db.models.fields.CharField')(default='ABC', unique=True, max_length=120)),
            ('backtest_interval', self.gf('django.db.models.fields.CharField')(default='ABC', unique=True, max_length=120)),
        ))
    ...
    models = {
        u'joins.backtest': {
            ...
            'backtest_endrange': ('django.db.models.fields.CharField', [], {'default': "'ABC'", 'unique': 'True', 'max_length': '120'}),
            'backtest_id': ('django.db.models.fields.CharField', [], {'default': "'ABC'", 'unique': 'True', 'max_length': '120'}),
            'backtest_interval': ('django.db.models.fields.CharField', [], {'default': "'ABC'", 'unique': 'True', 'max_length': '120'}),
            'backtest_startrange': ('django.db.models.fields.CharField', [], {'default': "'ABC'", 'unique': 'True', 'max_length': '120'}),
