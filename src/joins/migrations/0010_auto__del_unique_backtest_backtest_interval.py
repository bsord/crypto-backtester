...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Backtest', fields ['backtest_interval']
        db.delete_unique(u'joins_backtest', ['backtest_interval'])


    def backwards(self, orm):
        # Adding unique constraint on 'Backtest', fields ['backtest_interval']
        db.create_unique(u'joins_backtest', ['backtest_interval'])
